...
int gen_mainMenu(int* option)
{
    ...
    if(option != NULL)
    {
        ...
        printf("\n11. Eliminar lista enlazada");
        printf("\n12. Verificar si la lista actual esta vacia");
        printf("\n13. Alta de empleado en una posicion especifica");
        printf("\n14. Eliminar empleado y tomar sus datos");
        printf("\n15. Verificar la existencia de un empleado");
        printf("\n16. Comparar si dos listas enlazadas son iguales");
        printf("\n17. Crear copia de la lista enlazada actual con parametros(desde - hasta)");
        printf("\n18. Hacer copia exacta de la lista enlazada actual");
        printf("\n19. Salir");
        if(utn_getNumber(option, "\n\nSeleccionar una opcion: ", "Error, fuera de rango.", 1, 19, 2))
        {
            retorno = 1;
        }
        else
